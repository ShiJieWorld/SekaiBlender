...
set(PROJECT_DESCRIPTION  "SekaiBlender is the free and open source 3D creation suite software.")
set(PROJECT_COPYRIGHT    "Copyright (C) 2001-${CURRENT_YEAR} Blender Authors")
set(PROJECT_CONTACT      "foundation@blender.org")
set(PROJECT_VENDOR       "SekaiBlender")
...
set(CPACK_PACKAGE_NAME "${SEKAIBLENDER_PRODUCT_NAME}")
set(CPACK_PACKAGE_DESCRIPTION ${PROJECT_DESCRIPTION})
set(CPACK_PACKAGE_VENDOR ${PROJECT_VENDOR})
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${SEKAIBLENDER_PRODUCT_VERSION_STRING}")
...
string(TOLOWER "${SEKAIBLENDER_PRODUCT_NAME}" PROJECT_NAME_LOWER)
if(MSVC)
...
if(CPACK_OVERRIDE_PACKAGENAME)
  ...
  set(CPACK_PACKAGE_FILE_NAME ${PROJECT_NAME_LOWER}-${SEKAIBLENDER_PRODUCT_VERSION}-git${CPACK_DATE}.${BUILD_REV}-${PACKAGE_ARCH})
endif()
...
if(WIN32)
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "SekaiBlender/SekaiBlender 1.0")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "SekaiBlender/SekaiBlender 1.0")
...
set(CPACK_PACKAGE_EXECUTABLES "SekaiBlender-launcher" "SekaiBlender 1.0")
set(CPACK_CREATE_DESKTOP_LINKS "SekaiBlender-launcher" "SekaiBlender 1.0")
