...
TEST(eevee_shadow, page_pool_growth)
{
  EXPECT_EQ(shadow_page_count_with_headroom(2048, 2048), 2048);
  EXPECT_EQ(shadow_page_count_with_headroom(2048, 2341), 2944);
  EXPECT_EQ(shadow_page_count_with_headroom(2048, 4368), 5504);
  EXPECT_EQ(shadow_page_count_with_headroom(4096, 2341), 4096);
  EXPECT_EQ(shadow_page_count_with_headroom(4096, 9000), SHADOW_MAX_PAGE);
}
