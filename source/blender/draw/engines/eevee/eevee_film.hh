...
class Film {
 ...
 private:
  ...
  bool fsr_enabled_ = false;
  int fsr_quality_ = -1;
  float fsr_sharpness_ = -1.0f;
  float render_scale_ = 1.0f;
  bool32_t fsr_active_ = false;
  draw::FsrContext fsr_context_;
 ...
 public:
  ...
  bool use_scaled_resolution_get() const
  {
    return data_.scaling_factor != 1;
  }
